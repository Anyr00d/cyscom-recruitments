		...
		<div>
			{
				<div style={style}>
					...
					{Date.now() < new Date('2024-11-02').getTime() ? (
						...
						<center>
							<h1>
								Thank you for your interest in the CYSCOM Recruitment Program!
							</h1>
							<h2>
								The recruitment program is currently closed. Follow us on{' '}
								<a
									href='https://www.instagram.com/cyscomvit'
									target='_blank'
									rel='noreferrer'
								>
									Instagram
								</a>{' '}
								to know the results for this year's recruitments, or to know
								when we recruit next.
							</h2>
						</center>
					)}
				</div>
