...
export default function AssignInterview({ handleSubmit }) {
	...
	// Create date and slot options for each day
	//   August 27
	...
	//   August 31
	const day3Slot1 = generateTimeOptions('11:50', '13:20', 10);
	const day3Slot2 = generateTimeOptions('18:00', '19:20', 10);

	// September 1
	const day4Slot1 = generateTimeOptions('11:50', '13:20', 10);
	const day4Slot2 = generateTimeOptions('18:00', '19:20', 10);
	...
	return (
		<div>
			<Form form={form} name='basic' onFinish={handleSubmit} {...layout}>
				...
				>
					{/* Generate time options based on the day selected */}
					{day === '27' ? (
						<Select>
							{day1Slot1}
							{day1Slot2}
